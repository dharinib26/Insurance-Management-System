...
public class GlobalExceptionHandler {
	...
	public Map<String, String> handleResource(CustomerNotFoundException ex) {
	...
	public Map<String, String> handleAgent(AgentNotFoundException ex) {
		...
		LOGGER.error(" Agent Id : {}", ex.getMessage());
	...
	public Map<String, String> handlePolicy(PolicyNotFoundException ex) {

		LOGGER.error(" Policy Id : {}", ex.getMessage());
